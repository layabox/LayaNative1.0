...
/*
class Socket extends ConchSocket implements _EventTarget {
    dispatchEvent: (evt: Event) => boolean;//接口
    removeEventListener: (type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean) => void;//接口
    _onmessage: (data: ArrayBuffer | string) => void;
    onmessage: (data: MessageEvent) => void;
...
applyMixins(Socket, [EventTarget]);
window.Socket = Socket;
*/


class Socket extends EventTarget {
    private _nativeObj:ConchSocket=null;
...
// class WebSocket extends EventTarget implements NativeObjWrapper, ConchWebSocket{
//     binaryType: string;
