...
public:
	...
	void printAll( const char* p_sPath,int p_nTexturePoolSize, int p_nAtlasPoolSize, int p_nSoundPoolSize,int p_nImagePoolSize );
...
protected:
	...
	void printMemoryStatis(const char* p_sPath, int p_nTexturePoolSize, int p_nAtlasPoolSize,int p_nSoundPoolSize,int p_nImagePoolSize);
