...
declare class ConchNode implements IBuffer {
    ...
    setFPSNode(): void;
    setLoadingView(): void;
    addChildAt(c: ConchNode, i: number): void;
    removeChild(c: ConchNode): void;
    ...
    custom(t: CanvasRenderingContext2D): void;
...
declare class ConchGraphics implements IBuffer {
    private _cmds;
    private _temp;
    private _bounds;
    ...
    private _fands(fillColor, lineColor, lineWidth);
    ...
    drawImageM(img: HTMLImageElement, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number, mat: any): void;
    ...
    private _drawPs(fid, x, y, points, lineColor, lineWidth);
    ...
    _fillImage(pat: CanvasPattern, x: number, y: number, fx: number, fy: number, w: number, h: number): void;
}
interface IPlatForm {
    callBackList: Object;
...
declare class ConchFps extends ConchNode {
    color: string;
    fontstr: string;
    fontSize: number;
    fps: number;
