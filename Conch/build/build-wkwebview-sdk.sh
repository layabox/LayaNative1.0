...
lipo -create x86_64/libLayaWK.a i386/libLayaWK.a armv7a/libLayaWK.a armv64/libLayaWK.a -output WKWebview/libs/libLayaWK.a
...
#—————————————————————copy .h————————————————————————
cp -f LayaWKWebview/proj.ios/LayaWKWebview/conchConfig.h WKWebview/libs/include/conchConfig.h
cp -f LayaWKWebview/proj.ios/LayaWKWebview/LayaWKWebview.h WKWebview/libs/include/LayaWKWebview.h
