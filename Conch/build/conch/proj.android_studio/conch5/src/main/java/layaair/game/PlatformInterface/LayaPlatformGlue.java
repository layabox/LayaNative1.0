...
public class LayaPlatformGlue
{
	...
	public void CZ( String jsonParam )
	{
		Log.i("0",">>>>>uniPayForCoin");
		if( m_pPlatform != null )
		{
			m_pPlatform.LP_CZ( jsonParam );
		}
		else
		{
			LayaPlatformCallback.GetInstance().LP_onCZCallback(sNotSupport);
		}
	}
	...
	public void setCZInfo( String jsonParam )
	{
		Log.i("0",">>>>>setRechargeInfo param="+jsonParam);
		if( m_pPlatform != null )
		{
			m_pPlatform.LP_setCZInfo(jsonParam );
		}
	}
